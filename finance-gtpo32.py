...
class FinancialAnalyticsApp:
    def __init__(self, root):
        ...
        self.style.configure("Treeview", background=COLORS["bg_medium"], foreground=COLORS["text"],
                             fieldbackground=COLORS["bg_medium"])
        self.style.configure("Treeview.Heading", background=COLORS["accent"], foreground="white")
